...
import typescript from "refractor/lang/typescript"; // <-- added
import python from "refractor/lang/python";         // <-- added
...
Refractor.registerLanguage(typescript); // <-- added
Refractor.registerLanguage(python);     // <-- added
